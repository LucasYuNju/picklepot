package com.intel.picklepot.columnar.legacy.runlength;

public class RunLengthConstants {

  /*
   * The minimum number of repetitions seen before the writer switches to run
   * length encoding
   */
  ...
  /*
   * Max repetitions of a literal allowed in a 'run' which is run length
   * encoded
   */
